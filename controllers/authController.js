...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  If you didn't gorget your password, please ignore this email! `;
  try {
    await sendEmail({
      email: user.email,
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // 3) Update changedPasswordAt property for the user(do it in usermodule)
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  user.passwordConfirm = req.body.passwordConfirm;
  await user.save();
  //   User.findByIdAndUpdate  not use to relate about password  validator will not work
